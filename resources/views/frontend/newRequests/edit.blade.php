    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.new-requests.update", [$newRequest->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="available_from" id="available_from" value="{{ old('available_from', $newRequest->available_from) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="available_to" id="available_to" value="{{ old('available_to', $newRequest->available_to) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="credits" id="credits" value="{{ old('credits', $newRequest->credits) }}" step="1" required>
