            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @else
                    ...
                    <a class="nav-link" href="{{ route('frontend.home') }}">
                      <i class="fas fa-paw"></i>  {{ __('Find Pets') }}
                    </a>
                    </li>
                    <li class="nav-item px-2">
                    <a class="nav-link" href="{{ route('frontend.pets.index') }}">
                    <i class="fas fa-user"></i>  {{ __('My Pets') }}
                    </a>
                    </li>
                    <li class="nav-item px-2">
                    <a class="nav-link" href="{{ route('frontend.new-requests.index') }}">
                    <i class="fas fa-list"></i>  {{ __('Requests') }}
                    </a>
                    </li>
                    <li class="nav-item px-2">
                    <a class="nav-link" href="{{ route('frontend.credits.index') }}">
                    <i class="fas fa-money"></i>  {{ __('Credits') }}
                    </a>
                    </li>
                @endguest
                </ul>
                ...
                @else
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        @endcan
                        @can('member_review_access')
                        <a class="dropdown-item" href="{{ route('frontend.member-reviews.index') }}">
                            {{ trans('cruds.memberReview.title') }}
                        </a>
                        @endcan
                        ...
                        @endcan
                        @can('new_request_access')
                        <a class="dropdown-item" href="{{ route('frontend.new-requests.index') }}">
                            {{ trans('cruds.newRequest.title') }}
                        </a>
                        @endcan
