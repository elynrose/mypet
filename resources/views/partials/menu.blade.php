<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('new_request_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.new-requests.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/new-requests") || request()->is("admin/new-requests/*") ? "c-active" : "" }}">
        ...
        @can('member_review_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.member-reviews.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/member-reviews") || request()->is("admin/member-reviews/*") ? "c-active" : "" }}">
