...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.new-requests.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('available_from') ? 'is-invalid' : '' }}" type="text" name="available_from" id="available_from" value="{{ old('available_from') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('available_to') ? 'is-invalid' : '' }}" type="text" name="available_to" id="available_to" value="{{ old('available_to') }}">
