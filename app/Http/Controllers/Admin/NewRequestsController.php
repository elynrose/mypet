...
class NewRequestsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.newRequests.index', compact('newRequests'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.newRequests.create', compact('booked_bies', 'pets'));
    }
    ...
    public function store(StoreNewRequestRequest $request)
    {
        ...
        return redirect()->route('admin.new-requests.index');
    }
    ...
    public function edit(NewRequest $newRequest)
    {
        ...
        return view('admin.newRequests.edit', compact('booked_bies', 'newRequest', 'pets'));
    }
    ...
    public function show(NewRequest $newRequest)
    {
        ...
        return view('admin.newRequests.show', compact('newRequest'));
    }
