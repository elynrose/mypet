...
class MemberReviewsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.memberReviews.index', compact('memberReviews'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.memberReviews.create', compact('submitted_bies', 'users'));
    }
    ...
    public function store(StoreMemberReviewRequest $request)
    {
        ...
        return redirect()->route('admin.member-reviews.index');
    }
    ...
    public function edit(MemberReview $memberReview)
    {
        ...
        return view('admin.memberReviews.edit', compact('memberReview', 'submitted_bies', 'users'));
    }
    ...
    public function show(MemberReview $memberReview)
    {
        ...
        return view('admin.memberReviews.show', compact('memberReview'));
    }
